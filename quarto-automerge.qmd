...
format: 
  revealjs:
    footer: '<https://cscheid.net/to/2026-03-quarto-automerge.html>'
title: "Workshop: Q&A on Q+A"
subtitle: 'follow along at <https://cscheid.net/to/2026-03-quarto-automerge.html>'
...
::: {style="background: rgb(197, 176, 176)"}
`.qmd`
:::

→

::: {style="background: rgb(220, 177, 97)"}
AST
:::

→

::: {style="background: rgb(169, 213, 183)"}
HTML
:::
...
- **rich text**: some players in the session will use it
- **plain text**: some players in the session will use it

something, somewhere must manage a **bidirectional mapping between text and AST**
...
- two new ideas:
  - we can track source spans through the entire translation pipeline
  - tree diffing is efficient: embrace incremental writes
...
::: {.flex style="background: rgb(197, 176, 176)"}
...
::: {.flex style="background: rgb(220, 177, 97)"}
...
::: {.flex style="background: rgb(169, 213, 183)"}
